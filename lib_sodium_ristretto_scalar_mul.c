...
my_bool ristretto255_scalar_mul_init( UDF_INIT* initid, const UDF_ARGS* args,
                                      char* message )
{
    if( args->arg_count != 2 ) {
...
char* ristretto255_scalar_mul( const UDF_INIT* initid, const UDF_ARGS* args,
                               char* result,
                               unsigned long* length, char* is_null, char* error )
{
    ...
    crypto_core_ristretto255_scalar_mul( ( unsigned char* )result, scalar1,
                                         scalar2 );
