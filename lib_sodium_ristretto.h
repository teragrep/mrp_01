...
char* ristrettorandom(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                      char* error);
my_bool ristrettofromhash_init(UDF_INIT* initid, UDF_ARGS* args, char* message);
void ristrettofromhash_deinit(UDF_INIT* initid);
char* ristrettofromhash(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                        char* error);
...
char* scalarmultristretto(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                          char* error);
...
char* scalarmultristrettobase(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                              char* error);
...
char* ristrettoscalarrandom(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                            char* error);
...
char* ristrettoscalarreduce(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                            char* error);
...
char* ristrettoscalarinvert(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                            char* error);
...
char* ristrettoscalarnegate(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                            char* error);
...
char* ristrettoscalarcomplement(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                                char* error);
my_bool ristrettoscalaradd_init(UDF_INIT* initid, UDF_ARGS* args, char* message);
void ristrettoscalaradd_deinit(UDF_INIT* initid);
char* ristrettoscalaradd(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                         char* error);
my_bool ristrettoscalarsub_init(UDF_INIT* initid, UDF_ARGS* args, char* message);
void ristrettoscalarsub_deinit(UDF_INIT* initid);
char* ristrettoscalarsub(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                         char* error);
my_bool ristrettoscalarmul_init(UDF_INIT* initid, UDF_ARGS* args, char* message);
void ristrettoscalarmul_deinit(UDF_INIT* initid);
char* ristrettoscalarmul(UDF_INIT* initid, UDF_ARGS* args, char* result, unsigned long* length, char* is_null,
                         char* error);
